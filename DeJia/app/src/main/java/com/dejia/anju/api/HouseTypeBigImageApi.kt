...
//户型大图浏览接口
class HouseTypeBigImageApi : BaseCallBackApi {
    override fun getCallBack(context: Context, maps: MutableMap<String, Any>, listener: BaseCallBackListener<*>) {
        instance!!.call("building", "houseTypeBigImg", maps, context, ServerCallback { mData: ServerData? -> listener.onSuccess(mData) })
    }
}